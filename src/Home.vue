...
const menu = ref([
  ...
  { name: '测试', icon: 'M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z' },
  { name: '测试', icon: 'M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z' },
  { name: '设置', icon: 'M512 504L764.8 68.8h-134.4L512 275.2 393.6 70.4h-134.4L512 504zM819.2 70.4L512 600 204.8 68.8H0l512 886.4L1024 70.4H819.2z' }
])
</script>
...
<template>
  ...
  <wintab :menu="menu" titlebar="true" titlebartext="Web-Win-Vue"
    :url="['http://localhost:5173/#/test', 'http://localhost:5173/#/test', 'http://localhost:5173/#/test', 'http://localhost:5173/#/test', 'http://localhost:5173/#/test', 'http://localhost:5173/#/test', 'http://localhost:5173/#/test', 'http://localhost:5173/#/test', 'http://localhost:5173/#/test', 'http://localhost:5173/#/test']"
    style="height: calc( 100% - 0.9px );"><h1>aaaaaaaaaaaaaa</h1><h1>aaaaaaaaaaaaaa</h1><h1>aaaaaaaaaaaaaa</h1><h1>aaaaaaaaaaaaaa</h1><h1>aaaaaaaaaaaaaa</h1><h1>aaaaaaaaaaaaaa</h1><h1>aaaaaaaaaaaaaa</h1><h1>aaaaaaaaaaaaaa</h1><h1>aaaaaaaaaaaaaa</h1><h1>aaaaaaaaaaaaaa</h1></wintab>
</template>

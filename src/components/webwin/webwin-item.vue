<template>
  ...
  <ul class="side-bar" :class="fold">
    <div>
      <li style="margin-top: 24px;"  @click="toggleFold">
        ...
        <span class="label" :class="fold">折叠</span>
      </li>
      <div style="width: var(--sb-width, 350px);margin: auto;">
        <wininputbox placeholder="查找" class="inputbox" style="margin-top: 6px;width: 320px;transition: all 0.1s ease;" :class="fold"/>
      </div>
...
.side-bar {
  ...
  transition: width 0.15s cubic-bezier(0, 0.5, 0.00, 1.00);
  overflow:hidden
}
